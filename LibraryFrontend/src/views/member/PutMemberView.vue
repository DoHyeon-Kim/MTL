  ...
  <div class="signup-container">
    <form class="login" :class="{ 'guest-form': !isAdmin }">
      ...
      <div class="form-row">
        <label>ID</label>
        <div class="input-box">
          <input type="text" v-model="memberId" placeholder="IDを入力してください (6文字以上10文字以内)" disabled>
      ...
      <div class="form-row">
        <label>ひらがな</label>
        <div class="input-box">
          <input type="text" v-model="memberHiragana" placeholder="例: たろう" :disabled="!isAdmin">
      ...
      <div class="form-row">
        <label>カタカナ</label>
        <div class="input-box">
          <input type="text" v-model="memberKatakana" placeholder="例: タロウ" :disabled="!isAdmin">
